...
We use the Airbnb JavaScript and React Style Guide as a general reference. The Prettier configuration and rules below are the final style decisions for this project.
...
Set Prettier - Code formatter as the default formatter.
